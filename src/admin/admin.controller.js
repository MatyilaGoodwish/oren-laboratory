(function () {
    ...
    app.service("notificationSvc", function () {
        let notifications = [];
        this.currentNotifications = function () {
            let notificationRef = firebase.firestore().collection("app-notifications");
            notificationRef
            .get()
            .then((querySnapshot)=>querySnapshot.forEach(snap=>{
    ...
    app.controller("Admin", ["notificationSvc", "$cookies", "$location",
        function (notificationSvc, $cookies, $location) {

            //notifications
            this.notifications = notificationSvc.currentNotifications();
